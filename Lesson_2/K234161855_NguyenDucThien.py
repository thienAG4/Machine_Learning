...
class TextTranslatorApp:
    ...
    def translate_text(self):
        api_key = "AIzaSyDmpBu_uWKPTz1A5jBI1PtPB9MdnyCtdVk"
        text_to_translate = self.entry.get()
        url = f"https://translation.googleapis.com/v3/projects/$trusty-shine-472401-s2/locations/global:translateText?key=$AIzaSyDmpBu_uWKPTz1A5jBI1PtPB9MdnyCtdVk"
        params = {
            "q": text_to_translate,
    ...
    def create_widgets(self):
        ...
        label3=tk.Label(self.root,text="Choose source language:")
        ...
        self.source_lang.grid(row=2,column=0,padx=10,pady=10)
